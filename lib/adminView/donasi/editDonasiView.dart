...
class EditDonasiView extends StatefulWidget {
  final Donations data;

  const EditDonasiView({Key key, this.data}) : super(key: key);

  @override
  _EditDonasiViewState createState() => _EditDonasiViewState();
}

class _EditDonasiViewState extends State<EditDonasiView> {
  ...
  void initState() {
    ...
    super.initState();
    id = widget.data.idDonatur.toString();

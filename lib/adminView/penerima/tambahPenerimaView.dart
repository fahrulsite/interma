...
class TambahPenerimaView extends StatefulWidget {
  @override
  _TambahPenerimaViewState createState() => _TambahPenerimaViewState();
}
            ...
            child: Form(
              ...
              child: ListView(
                children: [
                  ...
                  InkWell(
                    onTap: ()=>ApiService.createPenerima(nama: nama.text, alamat: alamat.text, kontak: kontak.text).then((value) => {
